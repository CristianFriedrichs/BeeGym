                    ...
                    <div className="p-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-3 rounded-b-[12px]">
                        <Button
                            ...
                            onClick={() => {
                                toast({
                                    title: "Em breve",
                                    description: "A interface de cancelamento será liberada com o Gateway de Pagamentos."
                                })
                            }}
                        >
                            Cancelar Assinatura
...
function PlanSelectionView({
    ...
    const handleSelectPlan = (plan: BeeGymPlan, index: number) => {
        ...
        toast({
            title: isUpgrade ? "Upgrade Simulado" : "Downgrade Simulado",
            description: `Você estaria mudando para o plano ${plan.name}. A integração real com gateway ocorrerá em breve.`,
            variant: "default"
        });
    }
