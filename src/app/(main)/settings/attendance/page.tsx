    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Política de Presença e Cancelamento</CardTitle>
                        <CardDescription>
                            Defina as regras de presença e cancelamento de aulas.
                        </CardDescription>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Faltas e Penalidades</CardTitle>
                        <CardDescription>
                            Configure as regras de penalidade por acúmulo de faltas.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <FormField
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Alertas Automáticos (Retenção)</CardTitle>
                        <CardDescription>
                            Configure alertas para identificar alunos em risco de evasão.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <FormField
