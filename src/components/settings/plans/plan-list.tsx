...
import { MoreVertical, Edit, Power, PowerOff, Plus, Clock } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center px-1">
                <div>
                    <h3 className="text-lg font-medium">Planos de Venda</h3>
                    <p className="text-sm text-muted-foreground">Configure os pacotes e mensalidades oferecidos aos alunos.</p>
                </div>
